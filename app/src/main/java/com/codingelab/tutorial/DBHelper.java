...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public Cursor getData(int id){
        ...
        Cursor res =  db.rawQuery( "select * from contacts where id="+id+"", null );//////////////get id
        return res;
    }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public boolean updateContact (Integer id, String name, String phone, String email, String street,String place)//////////////// ubdat
    {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put("name", name);
...
///////////////////////////////////////////***********************************************************************////////////////////////////////
    public Cursor getAllData() ///////////////////////////// get data|||||||||||||||||||
    {
        SQLiteDatabase db = this.getReadableDatabase();
...
//////////////////////////////////%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%///////////////////////////////////////////
    public Cursor serach(String name)/////////////////////////////////////////////////////////////////////// serach
    {
        SQLiteDatabase db = this.getReadableDatabase();
