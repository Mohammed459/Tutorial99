...
///////////////////////////next botton =sql bouttpn//////////////////////////////////////////////////
    this.next.setOnClickListener(new View.OnClickListener() {
          @Override
          public void onClick(View v) {


              Intent intent = new Intent(getApplicationContext(),Main3Activity.class);//cod go next page
...
/////////////////////////////get all data///////////////////////////////////////////////////////////////////////////////
  ...
  private class GetUsersTask extends AsyncTask<String, String, String> {
    ...
    protected String doInBackground(String... strings) {
      ...
      String newsUrl = "http://192.168.8.101:80/sqli/getData.php";

      try {

        URL url = new URL(newsUrl);////conect php  date

        // /////////////////////Open url connection////////////////////////////////////////////
        HttpURLConnection httpConnection = (HttpURLConnection) url.openConnection();////conect php  date
